  ...
  return (
    <>
      ...
      <section className="min-h-screen bg-white text-black flex flex-col justify-center items-center px-6 text-center font-serif">
        <div className="mb-12">
          <h1 className="text-8xl font-extrabold tracking-tight drop-shadow-[0_0_15px_rgba(0,0,0,0.15)]">15</h1>
          <p className="text-4xl italic font-light drop-shadow-[0_0_10px_rgba(0,0,0,0.1)]">Fiorella</p>
        </div>
      ...
      {/* Cuenta regresiva */}
      <section className="min-h-screen bg-transparent text-white flex flex-col justify-center items-center px-6 text-center font-serif">
        <div className="w-full max-w-sm flex flex-col items-center border-t border-b border-white/30 py-12">
          <h2 className="text-4xl italic font-light mb-6 drop-shadow-[0_0_12px_rgba(255,255,255,0.4)]">Falta muy poco...</h2>
          <p className="text-3xl font-bold drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">{timeLeft}</p>
        </div>
      </section>
      ...
      <section className="min-h-screen bg-transparent text-white flex flex-col justify-center items-center px-6 text-center font-serif">
        <div className="w-full max-w-sm flex flex-col items-center border-t border-b border-white/30 py-12">
          <p className="text-2xl font-semibold mb-2 drop-shadow-[0_0_10px_rgba(255,255,255,0.4)]">📍 Allá Bodegón</p>
          <a
            href="https://www.instagram.com/alla.bodegon?igsh=bnZ2bzZhaGs4OTAw"
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm underline hover:opacity-80 mb-4 drop-shadow"
          >
            @alla.bodegon
          </a>
          <div className="rounded-xl overflow-hidden shadow border border-white/20 mt-2 w-full">
            <iframe
          ...
          <p className="text-sm mt-6 drop-shadow-sm">
            Te podés alojar en&nbsp;
            <a
      ...
      <section className="min-h-screen bg-transparent text-white flex flex-col justify-center items-center px-6 text-center font-serif">
        <div className="w-full max-w-sm flex flex-col items-center border-t border-b border-white/30 py-12">
          <h2 className="text-2xl font-semibold mb-4 drop-shadow-[0_0_10px_rgba(255,255,255,0.4)]">🎀 Dress Code</h2>
          <p className="text-sm mb-6 drop-shadow-sm">¿Querés inspirarte para tu look? Acá te dejamos ideas:</p>
          <a
            href="https://pin.it/2DrLz1i2W"
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm px-4 py-2 border border-white rounded-full hover:bg-white hover:text-black transition drop-shadow"
          >
            Ver inspiración
          </a>
        </div>
      ...
      <section className="min-h-screen bg-transparent text-white flex flex-col justify-center items-center px-6 text-center font-serif">
        <div className="w-full max-w-sm flex flex-col items-center border-t border-b border-white/30 py-12">
          <h2 className="text-2xl font-semibold mb-4 drop-shadow-[0_0_10px_rgba(255,255,255,0.4)]">🎶 ¡Sumá tu canción!</h2>
          <p className="text-sm mb-6 drop-shadow-sm">Ayudanos a armar la playlist para bailar toda la noche 💃🕺</p>
          <a
      ...
      <section className="min-h-screen bg-white text-black flex flex-col justify-center items-center px-6 text-center font-serif">
        <div className="mb-12">
          <h1 className="text-6xl font-extrabold tracking-tight drop-shadow-[0_0_15px_rgba(0,0,0,0.15)]">¿Venís?</h1>
          <p className="text-xl italic font-light drop-shadow-[0_0_10px_rgba(0,0,0,0.1)]">Confirmá tu asistencia</p>
        </div>
